...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    lazy var LogginButton: LGButton = {
        ...
        logginbutton.isUserInteractionEnabled = true
        logginbutton.addTarget(self, action: #selector(handleTap(gestureRecognizer:)), for: .touchUpInside)
        let gestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(handleTap))
        logginbutton.addGestureRecognizer(gestureRecognizer)
